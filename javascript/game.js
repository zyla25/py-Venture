...
let enemyObject = [
    ...
    //             question: "print<span class='span1' id='span1'></span>Instruction: Avi, what do you think is missing?<span class='span2' id='span2'></span>",
    //             firstOption: "( and )",
    //             secondOption: "{ and }",
    //             thirdOption: "[ and ]",
...
function generateChallenge () {
    ...
    if(typeQuestion === 1) {
            ...
            // let input1 = document.getElementById('input'); // get the input element
